...
async def list_put_options(
    ...
    option_yield_min: float | None = Query(
        default=None,
        description="Minimum put option yield.",
    ),
    option_yield_max: float | None = Query(
        default=None,
        description="Maximum put option yield.",
    ),
    ...
    # Safe sorting
    sort_by: PutOptionSortField | None = Query(
        default=None,
    ...
    """
    Retrieve a list of put options with Stage 5.1 discovery filters.
    ...
    - pagination
    """
    put_options, total = get_put_options(
        db=db,
        exchange=exchange,
        ticker=ticker,
        contract=contract,
