...
class LongPut(Base):
    ...
    __table_args__ = (
        Index("ix_lp_ticker_expiry", "ticker", "expiry_date"),
        Index("ix_lp_exchange_ticker_expiry", "exchange", "ticker", "expiry_date"),
        Index("ix_lp_exchange_ticker_expiry_contract", "exchange", "ticker", "expiry_date", "contract"),
    )
