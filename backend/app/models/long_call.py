...
class LongCall(Base):
    ...
    ask_per_share = Column(Float, nullable=False)
    ...
    profit_5pct = Column(Float, nullable=True)
    return_5pct = Column(Float, nullable=True)
    profit_10pct = Column(Float, nullable=True)
    return_10pct = Column(Float, nullable=True)
    ...
    __table_args__ = (
        Index("ix_lc_ticker_expiry", "ticker", "expiry_date"),
        Index("ix_lc_exchange_ticker_expiry", "exchange", "ticker", "expiry_date"),
        Index("ix_lc_exchange_ticker_expiry_contract", "exchange", "ticker", "expiry_date", "contract"),
    )
