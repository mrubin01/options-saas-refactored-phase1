...
## 12. Current Product Surface to Validate Before Production
...
Before production launch, smoke tests should explicitly cover:
- save / apply / rename / update / delete screener
- duplicate-name overwrite behavior
- add / remove watchlist item from strategy pages
- dedicated watchlist page behavior
- dashboard counts and recent sections

## 13. Stage 5 Preparation Notes

The next strategic platform phase should focus on:
- advanced filtering and sorting
- explainability / metric glossary
- ingestion automation
- data-contract hardening
- stronger end-to-end and migration validation

Production planning should therefore anticipate:
- more complex query/filter behavior
- clearer observability for ingestion freshness
- stronger deployment validation for data correctness
